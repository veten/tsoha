<?php include("yla.php"); 
// Listaa työntekijälle hänen omat vuoronsa kaikista julkaistuista listoista, merkiten vuoroja kirjain lyhentein. 	
?>
<h2>Omien tyovuorojen listaus kirjain-merkinnoin</h2>
